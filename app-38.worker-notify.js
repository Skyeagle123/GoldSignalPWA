...
// === [APPENDED BRIDGE] Worker alert hook ===

/* =====================================================
   GS → Worker notifier (add-only, no changes to your logic)
   Triggers only on a REAL signal (الإشارة: شراء/بيع) and
   skips summaries "(مرفوض بالفلاتر)" or "لا توجد نصيحة".
   ===================================================== */
(function(){
  ...
  // Watch the advice DOM node for changes
  ...
  if (target && !target.__gsNotifyWired){
    ...
    // also check current content once
